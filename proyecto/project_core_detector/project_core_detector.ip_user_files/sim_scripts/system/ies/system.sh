...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../project_core_detector.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../project_core_detector.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../project_core_detector.srcs/sources_1/bd/system/ipshared/b193/hdl" \
       +incdir+"../../../../project_core_detector.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../project_core_detector.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../project_core_detector.srcs/sources_1/bd/system/ipshared/b193/hdl" \
       +incdir+"/home/ezequiel/FPGA_vivado/Vivado/2018.1/data/xilinx_vip/include"
}
