...
# XDC: imports/fuente/core_detector_ArtyZ7_10.xdc
...
# IP: bd/system/ip/system_core_detector_ip_0_0/system_core_detector_ip_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_core_detector_ip_0_0 || ORIG_REF_NAME==system_core_detector_ip_0_0} -quiet] -quiet
